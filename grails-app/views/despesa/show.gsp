			...
			<ol class="property-list despesa">
				...
				<li class="fieldcontain">
					<span id="tipoDespesa-label" class="property-label"><g:message code="despesa.tipoDespesa.label" default="Tipo Despesa" /></span>
						...
						<span class="property-value" aria-labelledby="tipoDespesa-label"><g:link controller="tipoDespesa" action="show" id="${despesaInstance?.tipoDespesa?.id}">${despesaInstance?.tipoDespesa?.encodeAsHTML()}</g:link></span>
